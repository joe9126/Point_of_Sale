...
<script src="js/customjs/myscript.js" type="text/javascript"></script>
	...
	<div class="container-fluid">
      ...
      <div class="span2">
          <div class="well sidebar-nav">
			...
			<li><a href=""><i class="icon-cog icon-2x"></i> Settings</a></li>
			<br><br><br><br><br><br>		
			<li>
...
<!--/span-->
	...
	<div class="contentheader">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 25px #000; color:#fff;"><center>Prime Enterprises</center></font>
<div id="mainmain">
